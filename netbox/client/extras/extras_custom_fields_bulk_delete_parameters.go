...
// WithData adds the data to the extras custom fields bulk delete params
func (o *ExtrasCustomFieldsBulkDeleteParams) WithData(data []*models.DelObject) *ExtrasCustomFieldsBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the extras custom fields bulk delete params
func (o *ExtrasCustomFieldsBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
