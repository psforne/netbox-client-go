...
// WithData adds the data to the dcim power outlets bulk delete params
func (o *DcimPowerOutletsBulkDeleteParams) WithData(data []*models.DelObject) *DcimPowerOutletsBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim power outlets bulk delete params
func (o *DcimPowerOutletsBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
