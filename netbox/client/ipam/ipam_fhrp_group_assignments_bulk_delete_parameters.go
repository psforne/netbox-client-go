...
// WithData adds the data to the ipam fhrp group assignments bulk delete params
func (o *IpamFhrpGroupAssignmentsBulkDeleteParams) WithData(data []*models.DelObject) *IpamFhrpGroupAssignmentsBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the ipam fhrp group assignments bulk delete params
func (o *IpamFhrpGroupAssignmentsBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
