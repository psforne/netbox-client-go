...
// WithData adds the data to the dcim virtual chassis bulk delete params
func (o *DcimVirtualChassisBulkDeleteParams) WithData(data []*models.DelObject) *DcimVirtualChassisBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim virtual chassis bulk delete params
func (o *DcimVirtualChassisBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
