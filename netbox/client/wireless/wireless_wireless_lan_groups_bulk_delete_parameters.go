...
// WithData adds the data to the wireless wireless lan groups bulk delete params
func (o *WirelessWirelessLanGroupsBulkDeleteParams) WithData(data []*models.DelObject) *WirelessWirelessLanGroupsBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the wireless wireless lan groups bulk delete params
func (o *WirelessWirelessLanGroupsBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
