...
// WithData adds the data to the ipam route targets bulk delete params
func (o *IpamRouteTargetsBulkDeleteParams) WithData(data []*models.DelObject) *IpamRouteTargetsBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the ipam route targets bulk delete params
func (o *IpamRouteTargetsBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
