...
// WithData adds the data to the ipam prefixes bulk delete params
func (o *IpamPrefixesBulkDeleteParams) WithData(data []*models.DelObject) *IpamPrefixesBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the ipam prefixes bulk delete params
func (o *IpamPrefixesBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
