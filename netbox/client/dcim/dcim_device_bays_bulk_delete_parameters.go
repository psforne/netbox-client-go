...
// WithData adds the data to the dcim device bays bulk delete params
func (o *DcimDeviceBaysBulkDeleteParams) WithData(data []*models.DelObject) *DcimDeviceBaysBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim device bays bulk delete params
func (o *DcimDeviceBaysBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
