...
// WithData adds the data to the dcim inventory item templates bulk delete params
func (o *DcimInventoryItemTemplatesBulkDeleteParams) WithData(data []*models.DelObject) *DcimInventoryItemTemplatesBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim inventory item templates bulk delete params
func (o *DcimInventoryItemTemplatesBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
