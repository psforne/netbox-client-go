...
// WithData adds the data to the tenancy contact roles bulk delete params
func (o *TenancyContactRolesBulkDeleteParams) WithData(data []*models.DelObject) *TenancyContactRolesBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the tenancy contact roles bulk delete params
func (o *TenancyContactRolesBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
