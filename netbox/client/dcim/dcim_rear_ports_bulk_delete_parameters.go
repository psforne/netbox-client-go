...
// WithData adds the data to the dcim rear ports bulk delete params
func (o *DcimRearPortsBulkDeleteParams) WithData(data []*models.DelObject) *DcimRearPortsBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim rear ports bulk delete params
func (o *DcimRearPortsBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
