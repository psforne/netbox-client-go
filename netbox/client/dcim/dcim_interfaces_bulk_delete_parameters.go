...
// WithData adds the data to the dcim interfaces bulk delete params
func (o *DcimInterfacesBulkDeleteParams) WithData(data []*models.DelObject) *DcimInterfacesBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim interfaces bulk delete params
func (o *DcimInterfacesBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
