...
// WithData adds the data to the ipam ip ranges bulk delete params
func (o *IpamIPRangesBulkDeleteParams) WithData(data []*models.DelObject) *IpamIPRangesBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the ipam ip ranges bulk delete params
func (o *IpamIPRangesBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
