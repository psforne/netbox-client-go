...
// WithData adds the data to the wireless wireless lans bulk delete params
func (o *WirelessWirelessLansBulkDeleteParams) WithData(data []*models.DelObject) *WirelessWirelessLansBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the wireless wireless lans bulk delete params
func (o *WirelessWirelessLansBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
