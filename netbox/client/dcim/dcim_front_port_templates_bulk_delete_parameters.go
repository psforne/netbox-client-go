...
// WithData adds the data to the dcim front port templates bulk delete params
func (o *DcimFrontPortTemplatesBulkDeleteParams) WithData(data []*models.DelObject) *DcimFrontPortTemplatesBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim front port templates bulk delete params
func (o *DcimFrontPortTemplatesBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
