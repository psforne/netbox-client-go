...
// WithData adds the data to the dcim module bays bulk delete params
func (o *DcimModuleBaysBulkDeleteParams) WithData(data []*models.DelObject) *DcimModuleBaysBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim module bays bulk delete params
func (o *DcimModuleBaysBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
