...
// WithData adds the data to the ipam rirs bulk delete params
func (o *IpamRirsBulkDeleteParams) WithData(data []*models.DelObject) *IpamRirsBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the ipam rirs bulk delete params
func (o *IpamRirsBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
