...
// WithData adds the data to the dcim manufacturers bulk delete params
func (o *DcimManufacturersBulkDeleteParams) WithData(data []*models.DelObject) *DcimManufacturersBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim manufacturers bulk delete params
func (o *DcimManufacturersBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
