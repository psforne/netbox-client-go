...
// WithData adds the data to the dcim console ports bulk delete params
func (o *DcimConsolePortsBulkDeleteParams) WithData(data []*models.DelObject) *DcimConsolePortsBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim console ports bulk delete params
func (o *DcimConsolePortsBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
