...
// WithData adds the data to the dcim power panels bulk delete params
func (o *DcimPowerPanelsBulkDeleteParams) WithData(data []*models.DelObject) *DcimPowerPanelsBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim power panels bulk delete params
func (o *DcimPowerPanelsBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
