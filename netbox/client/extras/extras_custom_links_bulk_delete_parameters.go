...
// WithData adds the data to the extras custom links bulk delete params
func (o *ExtrasCustomLinksBulkDeleteParams) WithData(data []*models.DelObject) *ExtrasCustomLinksBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the extras custom links bulk delete params
func (o *ExtrasCustomLinksBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
