...
// WithData adds the data to the dcim power port templates bulk delete params
func (o *DcimPowerPortTemplatesBulkDeleteParams) WithData(data []*models.DelObject) *DcimPowerPortTemplatesBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim power port templates bulk delete params
func (o *DcimPowerPortTemplatesBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
