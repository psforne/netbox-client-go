...
// WithData adds the data to the ipam roles bulk delete params
func (o *IpamRolesBulkDeleteParams) WithData(data []*models.DelObject) *IpamRolesBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the ipam roles bulk delete params
func (o *IpamRolesBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
