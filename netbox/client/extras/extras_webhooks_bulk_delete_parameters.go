...
// WithData adds the data to the extras webhooks bulk delete params
func (o *ExtrasWebhooksBulkDeleteParams) WithData(data []*models.DelObject) *ExtrasWebhooksBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the extras webhooks bulk delete params
func (o *ExtrasWebhooksBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
