...
// WithData adds the data to the dcim platforms bulk delete params
func (o *DcimPlatformsBulkDeleteParams) WithData(data []*models.DelObject) *DcimPlatformsBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim platforms bulk delete params
func (o *DcimPlatformsBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
