...
// WithData adds the data to the users users bulk delete params
func (o *UsersUsersBulkDeleteParams) WithData(data []*models.DelObject) *UsersUsersBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the users users bulk delete params
func (o *UsersUsersBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
