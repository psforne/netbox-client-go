...
// WithData adds the data to the dcim device bay templates bulk delete params
func (o *DcimDeviceBayTemplatesBulkDeleteParams) WithData(data []*models.DelObject) *DcimDeviceBayTemplatesBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim device bay templates bulk delete params
func (o *DcimDeviceBayTemplatesBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
