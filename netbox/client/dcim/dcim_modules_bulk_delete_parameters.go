...
// WithData adds the data to the dcim modules bulk delete params
func (o *DcimModulesBulkDeleteParams) WithData(data []*models.DelObject) *DcimModulesBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim modules bulk delete params
func (o *DcimModulesBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
