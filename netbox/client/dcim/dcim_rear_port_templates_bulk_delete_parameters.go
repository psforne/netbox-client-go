...
// WithData adds the data to the dcim rear port templates bulk delete params
func (o *DcimRearPortTemplatesBulkDeleteParams) WithData(data []*models.DelObject) *DcimRearPortTemplatesBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim rear port templates bulk delete params
func (o *DcimRearPortTemplatesBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
