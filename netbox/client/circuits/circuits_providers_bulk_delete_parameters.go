...
// WithData adds the data to the circuits providers bulk delete params
func (o *CircuitsProvidersBulkDeleteParams) WithData(data []*models.DelObject) *CircuitsProvidersBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the circuits providers bulk delete params
func (o *CircuitsProvidersBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
