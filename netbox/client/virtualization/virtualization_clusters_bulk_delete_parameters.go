...
// WithData adds the data to the virtualization clusters bulk delete params
func (o *VirtualizationClustersBulkDeleteParams) WithData(data []*models.DelObject) *VirtualizationClustersBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the virtualization clusters bulk delete params
func (o *VirtualizationClustersBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
