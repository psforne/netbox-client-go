...
// WithData adds the data to the tenancy contact groups bulk delete params
func (o *TenancyContactGroupsBulkDeleteParams) WithData(data []*models.DelObject) *TenancyContactGroupsBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the tenancy contact groups bulk delete params
func (o *TenancyContactGroupsBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
