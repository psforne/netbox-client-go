...
// WithData adds the data to the tenancy tenant groups bulk delete params
func (o *TenancyTenantGroupsBulkDeleteParams) WithData(data []*models.DelObject) *TenancyTenantGroupsBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the tenancy tenant groups bulk delete params
func (o *TenancyTenantGroupsBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
