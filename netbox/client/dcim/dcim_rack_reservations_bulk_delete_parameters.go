...
// WithData adds the data to the dcim rack reservations bulk delete params
func (o *DcimRackReservationsBulkDeleteParams) WithData(data []*models.DelObject) *DcimRackReservationsBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim rack reservations bulk delete params
func (o *DcimRackReservationsBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
