...
// WithData adds the data to the dcim inventory items bulk delete params
func (o *DcimInventoryItemsBulkDeleteParams) WithData(data []*models.DelObject) *DcimInventoryItemsBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim inventory items bulk delete params
func (o *DcimInventoryItemsBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
