...
// WithData adds the data to the ipam ip addresses bulk delete params
func (o *IpamIPAddressesBulkDeleteParams) WithData(data []*models.DelObject) *IpamIPAddressesBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the ipam ip addresses bulk delete params
func (o *IpamIPAddressesBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
