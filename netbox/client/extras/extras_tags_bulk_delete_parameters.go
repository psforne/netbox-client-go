...
// WithData adds the data to the extras tags bulk delete params
func (o *ExtrasTagsBulkDeleteParams) WithData(data []*models.DelObject) *ExtrasTagsBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the extras tags bulk delete params
func (o *ExtrasTagsBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
