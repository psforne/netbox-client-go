...
// WithData adds the data to the dcim front ports bulk delete params
func (o *DcimFrontPortsBulkDeleteParams) WithData(data []*models.DelObject) *DcimFrontPortsBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim front ports bulk delete params
func (o *DcimFrontPortsBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
