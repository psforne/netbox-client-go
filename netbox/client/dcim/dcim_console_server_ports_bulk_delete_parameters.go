...
// WithData adds the data to the dcim console server ports bulk delete params
func (o *DcimConsoleServerPortsBulkDeleteParams) WithData(data []*models.DelObject) *DcimConsoleServerPortsBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim console server ports bulk delete params
func (o *DcimConsoleServerPortsBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
