...
// WithData adds the data to the dcim power outlet templates bulk delete params
func (o *DcimPowerOutletTemplatesBulkDeleteParams) WithData(data []*models.DelObject) *DcimPowerOutletTemplatesBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim power outlet templates bulk delete params
func (o *DcimPowerOutletTemplatesBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
