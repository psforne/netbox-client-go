...
// WithData adds the data to the ipam asns bulk delete params
func (o *IpamAsnsBulkDeleteParams) WithData(data []*models.DelObject) *IpamAsnsBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the ipam asns bulk delete params
func (o *IpamAsnsBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
