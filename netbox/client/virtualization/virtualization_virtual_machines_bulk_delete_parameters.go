...
// WithData adds the data to the virtualization virtual machines bulk delete params
func (o *VirtualizationVirtualMachinesBulkDeleteParams) WithData(data []*models.DelObject) *VirtualizationVirtualMachinesBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the virtualization virtual machines bulk delete params
func (o *VirtualizationVirtualMachinesBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
