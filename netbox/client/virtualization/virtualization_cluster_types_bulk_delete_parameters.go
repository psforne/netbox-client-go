...
// WithData adds the data to the virtualization cluster types bulk delete params
func (o *VirtualizationClusterTypesBulkDeleteParams) WithData(data []*models.DelObject) *VirtualizationClusterTypesBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the virtualization cluster types bulk delete params
func (o *VirtualizationClusterTypesBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
