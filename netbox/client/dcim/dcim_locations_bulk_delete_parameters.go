...
// WithData adds the data to the dcim locations bulk delete params
func (o *DcimLocationsBulkDeleteParams) WithData(data []*models.DelObject) *DcimLocationsBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim locations bulk delete params
func (o *DcimLocationsBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
