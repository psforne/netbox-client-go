...
// WithData adds the data to the ipam service templates bulk delete params
func (o *IpamServiceTemplatesBulkDeleteParams) WithData(data []*models.DelObject) *IpamServiceTemplatesBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the ipam service templates bulk delete params
func (o *IpamServiceTemplatesBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
