...
// WithData adds the data to the extras image attachments bulk delete params
func (o *ExtrasImageAttachmentsBulkDeleteParams) WithData(data []*models.DelObject) *ExtrasImageAttachmentsBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the extras image attachments bulk delete params
func (o *ExtrasImageAttachmentsBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
