...
// WithData adds the data to the users permissions bulk delete params
func (o *UsersPermissionsBulkDeleteParams) WithData(data []*models.DelObject) *UsersPermissionsBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the users permissions bulk delete params
func (o *UsersPermissionsBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
