...
// WithData adds the data to the tenancy tenants bulk delete params
func (o *TenancyTenantsBulkDeleteParams) WithData(data []*models.DelObject) *TenancyTenantsBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the tenancy tenants bulk delete params
func (o *TenancyTenantsBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
