...
// WithData adds the data to the extras journal entries bulk delete params
func (o *ExtrasJournalEntriesBulkDeleteParams) WithData(data []*models.DelObject) *ExtrasJournalEntriesBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the extras journal entries bulk delete params
func (o *ExtrasJournalEntriesBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
