...
// WithData adds the data to the dcim racks bulk delete params
func (o *DcimRacksBulkDeleteParams) WithData(data []*models.DelObject) *DcimRacksBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim racks bulk delete params
func (o *DcimRacksBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
