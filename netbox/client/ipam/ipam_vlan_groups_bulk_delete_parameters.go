...
// WithData adds the data to the ipam vlan groups bulk delete params
func (o *IpamVlanGroupsBulkDeleteParams) WithData(data []*models.DelObject) *IpamVlanGroupsBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the ipam vlan groups bulk delete params
func (o *IpamVlanGroupsBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
