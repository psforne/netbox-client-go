...
// WithData adds the data to the dcim rack roles bulk delete params
func (o *DcimRackRolesBulkDeleteParams) WithData(data []*models.DelObject) *DcimRackRolesBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim rack roles bulk delete params
func (o *DcimRackRolesBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
