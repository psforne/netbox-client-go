...
// WithData adds the data to the dcim console port templates bulk delete params
func (o *DcimConsolePortTemplatesBulkDeleteParams) WithData(data []*models.DelObject) *DcimConsolePortTemplatesBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim console port templates bulk delete params
func (o *DcimConsolePortTemplatesBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
