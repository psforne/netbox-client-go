...
// WithData adds the data to the dcim regions bulk delete params
func (o *DcimRegionsBulkDeleteParams) WithData(data []*models.DelObject) *DcimRegionsBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim regions bulk delete params
func (o *DcimRegionsBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
