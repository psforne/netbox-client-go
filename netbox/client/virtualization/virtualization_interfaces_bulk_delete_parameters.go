...
// WithData adds the data to the virtualization interfaces bulk delete params
func (o *VirtualizationInterfacesBulkDeleteParams) WithData(data []*models.DelObject) *VirtualizationInterfacesBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the virtualization interfaces bulk delete params
func (o *VirtualizationInterfacesBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
