...
// WithData adds the data to the dcim sites bulk delete params
func (o *DcimSitesBulkDeleteParams) WithData(data []*models.DelObject) *DcimSitesBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim sites bulk delete params
func (o *DcimSitesBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
