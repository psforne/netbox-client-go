...
// WithData adds the data to the dcim device roles bulk delete params
func (o *DcimDeviceRolesBulkDeleteParams) WithData(data []*models.DelObject) *DcimDeviceRolesBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim device roles bulk delete params
func (o *DcimDeviceRolesBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
