...
// WithData adds the data to the users tokens bulk delete params
func (o *UsersTokensBulkDeleteParams) WithData(data []*models.DelObject) *UsersTokensBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the users tokens bulk delete params
func (o *UsersTokensBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
