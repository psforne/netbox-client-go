...
// WithData adds the data to the users groups bulk delete params
func (o *UsersGroupsBulkDeleteParams) WithData(data []*models.DelObject) *UsersGroupsBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the users groups bulk delete params
func (o *UsersGroupsBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
