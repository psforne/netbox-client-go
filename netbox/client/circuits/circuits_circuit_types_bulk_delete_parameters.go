...
// WithData adds the data to the circuits circuit types bulk delete params
func (o *CircuitsCircuitTypesBulkDeleteParams) WithData(data []*models.DelObject) *CircuitsCircuitTypesBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the circuits circuit types bulk delete params
func (o *CircuitsCircuitTypesBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
