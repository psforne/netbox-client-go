...
// WithData adds the data to the ipam aggregates bulk delete params
func (o *IpamAggregatesBulkDeleteParams) WithData(data []*models.DelObject) *IpamAggregatesBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the ipam aggregates bulk delete params
func (o *IpamAggregatesBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
