...
// WithData adds the data to the ipam fhrp groups bulk delete params
func (o *IpamFhrpGroupsBulkDeleteParams) WithData(data []*models.DelObject) *IpamFhrpGroupsBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the ipam fhrp groups bulk delete params
func (o *IpamFhrpGroupsBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
