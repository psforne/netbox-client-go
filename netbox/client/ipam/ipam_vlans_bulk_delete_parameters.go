...
// WithData adds the data to the ipam vlans bulk delete params
func (o *IpamVlansBulkDeleteParams) WithData(data []*models.DelObject) *IpamVlansBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the ipam vlans bulk delete params
func (o *IpamVlansBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
