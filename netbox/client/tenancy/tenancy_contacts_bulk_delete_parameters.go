...
// WithData adds the data to the tenancy contacts bulk delete params
func (o *TenancyContactsBulkDeleteParams) WithData(data []*models.DelObject) *TenancyContactsBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the tenancy contacts bulk delete params
func (o *TenancyContactsBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
