...
// WithData adds the data to the extras config contexts bulk delete params
func (o *ExtrasConfigContextsBulkDeleteParams) WithData(data []*models.DelObject) *ExtrasConfigContextsBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the extras config contexts bulk delete params
func (o *ExtrasConfigContextsBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
