...
// WithData adds the data to the dcim power ports bulk delete params
func (o *DcimPowerPortsBulkDeleteParams) WithData(data []*models.DelObject) *DcimPowerPortsBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim power ports bulk delete params
func (o *DcimPowerPortsBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
