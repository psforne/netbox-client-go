...
// WithData adds the data to the extras export templates bulk delete params
func (o *ExtrasExportTemplatesBulkDeleteParams) WithData(data []*models.DelObject) *ExtrasExportTemplatesBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the extras export templates bulk delete params
func (o *ExtrasExportTemplatesBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
