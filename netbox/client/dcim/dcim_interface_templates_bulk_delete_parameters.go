...
// WithData adds the data to the dcim interface templates bulk delete params
func (o *DcimInterfaceTemplatesBulkDeleteParams) WithData(data []*models.DelObject) *DcimInterfaceTemplatesBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim interface templates bulk delete params
func (o *DcimInterfaceTemplatesBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
