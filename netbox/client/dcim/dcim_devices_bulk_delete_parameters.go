...
// WithData adds the data to the dcim devices bulk delete params
func (o *DcimDevicesBulkDeleteParams) WithData(data []*models.DelObject) *DcimDevicesBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim devices bulk delete params
func (o *DcimDevicesBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
