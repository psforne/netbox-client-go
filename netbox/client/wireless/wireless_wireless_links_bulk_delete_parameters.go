...
// WithData adds the data to the wireless wireless links bulk delete params
func (o *WirelessWirelessLinksBulkDeleteParams) WithData(data []*models.DelObject) *WirelessWirelessLinksBulkDeleteParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the wireless wireless links bulk delete params
func (o *WirelessWirelessLinksBulkDeleteParams) SetData(data []*models.DelObject) {
	o.Data = data
}
